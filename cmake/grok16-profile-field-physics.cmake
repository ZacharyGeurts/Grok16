# Grok16 field_physics profile — belt_2_0 throughput without -ffast-math (entropy/FP invariants)
if(NOT GROK16_PROFILE STREQUAL "field_physics")
  set(GROK16_PROFILE "field_physics" CACHE STRING "Grok16 build profile" FORCE)
endif()
set(GROK16_CXX_STD "gnu++26" CACHE STRING "Grok16 C++ standard" FORCE)
add_compile_definitions(
  GROK16_PROFILE_FIELD_PHYSICS=1
  GROK16_BELT_2_0=1
  GROK16_DISTRO_2_0=1
  G16_FIELD_SPEED=1
