...
# Linux host deps — FindVulkan/FindFreetype miss .so when only headers/pkg-config are present.
if(UNIX AND NOT APPLE AND NOT EMSCRIPTEN)
  if(NOT Vulkan_LIBRARY AND EXISTS "/usr/lib/x86_64-linux-gnu/libvulkan.so")
    set(Vulkan_LIBRARY "/usr/lib/x86_64-linux-gnu/libvulkan.so" CACHE FILEPATH "Vulkan loader" FORCE)
  endif()
  if(NOT Vulkan_INCLUDE_DIR AND EXISTS "/usr/include/vulkan/vulkan.h")
    set(Vulkan_INCLUDE_DIR "/usr/include" CACHE PATH "Vulkan headers" FORCE)
  endif()
  if(NOT FREETYPE_LIBRARY AND EXISTS "/usr/lib/x86_64-linux-gnu/libfreetype.so")
    set(FREETYPE_LIBRARY "/usr/lib/x86_64-linux-gnu/libfreetype.so" CACHE FILEPATH "FreeType" FORCE)
  endif()
  if(NOT FREETYPE_INCLUDE_DIRS AND EXISTS "/usr/include/freetype2/ft2build.h")
    set(FREETYPE_INCLUDE_DIRS "/usr/include/freetype2" CACHE PATH "FreeType headers" FORCE)
  endif()
  if(NOT ZLIB_LIBRARY AND EXISTS "/usr/lib/x86_64-linux-gnu/libz.so")
    set(ZLIB_LIBRARY "/usr/lib/x86_64-linux-gnu/libz.so" CACHE FILEPATH "zlib" FORCE)
  endif()
  if(NOT ZLIB_INCLUDE_DIR AND EXISTS "/usr/include/zlib.h")
    set(ZLIB_INCLUDE_DIR "/usr/include" CACHE PATH "zlib headers" FORCE)
  endif()
  if(EXISTS "/usr/local/include/SDL3/SDL.h")
