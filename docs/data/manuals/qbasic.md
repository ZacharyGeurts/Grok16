...
![Cover — Explaining QBasic](h7fig:cover)

Hostess 7 programming language manual — complete reference distilled from the
QBasic combinatronic pack and boiled to the g16 program facet (36 canonical ops).

- **Language id:** `qbasic`
- **Command entries:** 84
- **Canonical ops used:** 19
- **Generated:** 2026-06-29T12:14:38Z
- **Format:** H7c v3 with embedded figures

## At a glance

QBasic is catalogued in the Field program combinatronic seed.
...
This manual explains every seeded QBasic construct: surface syntax, semantic role,
...
## QBasic commands by canonical op
...
## QBasic full command reference

### `ENVIRON`
- **Boils to:** `assign` — Assign / bind / set
- **Runner:** from canonical op belt map
- **Verify:** `field-program-combinatronic.py boil qbasic "ENVIRON"`

### `LET`
- **Boils to:** `assign` — Assign / bind / set
- **Runner:** from canonical op belt map
- **Verify:** `field-program-combinatronic.py boil qbasic "LET"`

### `NAME`
- **Boils to:** `assign` — Assign / bind / set
- **Runner:** from canonical op belt map
- **Verify:** `field-program-combinatronic.py boil qbasic "NAME"`

### `CASE ELSE`
- **Boils to:** `branch` — Branch / if / switch
- **Runner:** from canonical op belt map
- **Verify:** `field-program-combinatronic.py boil qbasic "CASE ELSE"`

### `ELSE`
- **Boils to:** `branch` — Branch / if / switch
- **Runner:** from canonical op belt map
- **Verify:** `field-program-combinatronic.py boil qbasic "ELSE"`

### `ELSEIF`
- **Boils to:** `branch` — Branch / if / switch
- **Runner:** from canonical op belt map
- **Verify:** `field-program-combinatronic.py boil qbasic "ELSEIF"`

### `ENDIF`
- **Boils to:** `branch` — Branch / if / switch
- **Runner:** from canonical op belt map
- **Verify:** `field-program-combinatronic.py boil qbasic "ENDIF"`

### `GOTO`
- **Boils to:** `branch` — Branch / if / switch
- **Runner:** from canonical op belt map
- **Verify:** `field-program-combinatronic.py boil qbasic "GOTO"`

### `IF`
- **Boils to:** `branch` — Branch / if / switch
- **Runner:** from canonical op belt map
- **Verify:** `field-program-combinatronic.py boil qbasic "IF"`

### `ON`
- **Boils to:** `branch` — Branch / if / switch
- **Runner:** from canonical op belt map
- **Verify:** `field-program-combinatronic.py boil qbasic "ON"`

### `THEN`
- **Boils to:** `branch` — Branch / if / switch
- **Runner:** from canonical op belt map
- **Verify:** `field-program-combinatronic.py boil qbasic "THEN"`

### `EXIT`
- **Boils to:** `break` — Break / leave loop
- **Runner:** from canonical op belt map
- **Verify:** `field-program-combinatronic.py boil qbasic "EXIT"`

### `CALL`
- **Boils to:** `call` — Call / invoke / apply
- **Runner:** from canonical op belt map
- **Verify:** `field-program-combinatronic.py boil qbasic "CALL"`

### `GOSUB`
- **Boils to:** `call` — Call / invoke / apply
- **Runner:** from canonical op belt map
- **Verify:** `field-program-combinatronic.py boil qbasic "GOSUB"`

### `LEN`
- **Boils to:** `call` — Call / invoke / apply
- **Runner:** from canonical op belt map
- **Verify:** `field-program-combinatronic.py boil qbasic "LEN"`

### `USR`
- **Boils to:** `call` — Call / invoke / apply
- **Runner:** from canonical op belt map
- **Verify:** `field-program-combinatronic.py boil qbasic "USR"`

### `CINT`
- **Boils to:** `cast` — Cast / convert / coerce
- **Runner:** from canonical op belt map
- **Verify:** `field-program-combinatronic.py boil qbasic "CINT"`

### `VAL`
- **Boils to:** `cast` — Cast / convert / coerce
- **Runner:** from canonical op belt map
- **Verify:** `field-program-combinatronic.py boil qbasic "VAL"`

### `INSTR`
- **Boils to:** `compare` — Compare / eq / ord
- **Runner:** from canonical op belt map
- **Verify:** `field-program-combinatronic.py boil qbasic "INSTR"`

### `CONTINUE`
- **Boils to:** `continue` — Continue / next iteration
- **Runner:** from canonical op belt map
- **Verify:** `field-program-combinatronic.py boil qbasic "CONTINUE"`

### `BYVAL`
- **Boils to:** `declare` — Declare / define / let
- **Runner:** from canonical op belt map
- **Verify:** `field-program-combinatronic.py boil qbasic "BYVAL"`

### `DATA`
- **Boils to:** `declare` — Declare / define / let
- **Runner:** from canonical op belt map
- **Verify:** `field-program-combinatronic.py boil qbasic "DATA"`

### `DECLARE`
- **Boils to:** `declare` — Declare / define / let
- **Runner:** from canonical op belt map
- **Verify:** `field-program-combinatronic.py boil qbasic "DECLARE"`

### `DEF`
- **Boils to:** `declare` — Declare / define / let
- **Runner:** from canonical op belt map
- **Verify:** `field-program-combinatronic.py boil qbasic "DEF"`

### `DEFINT`
- **Boils to:** `declare` — Declare / define / let
- **Runner:** from canonical op belt map
- **Verify:** `field-program-combinatronic.py boil qbasic "DEFINT"`

### `DEFSTR`
- **Boils to:** `declare` — Declare / define / let
- **Runner:** from canonical op belt map
- **Verify:** `field-program-combinatronic.py boil qbasic "DEFSTR"`

### `DIM`
- **Boils to:** `declare` — Declare / define / let
- **Runner:** from canonical op belt map
- **Verify:** `field-program-combinatronic.py boil qbasic "DIM"`

### `FUNCTION`
- **Boils to:** `declare` — Declare / define / let
- **Runner:** from canonical op belt map
- **Verify:** `field-program-combinatronic.py boil qbasic "FUNCTION"`

### `REM`
- **Boils to:** `declare` — Declare / define / let
- **Runner:** from canonical op belt map
- **Verify:** `field-program-combinatronic.py boil qbasic "REM"`

### `SHARED`
- **Boils to:** `declare` — Declare / define / let
- **Runner:** from canonical op belt map
- **Verify:** `field-program-combinatronic.py boil qbasic "SHARED"`

### `STATIC`
- **Boils to:** `declare` — Declare / define / let
- **Runner:** from canonical op belt map
- **Verify:** `field-program-combinatronic.py boil qbasic "STATIC"`

### `SUB`
- **Boils to:** `declare` — Declare / define / let
- **Runner:** from canonical op belt map
- **Verify:** `field-program-combinatronic.py boil qbasic "SUB"`

### `NEW`
- **Boils to:** `exec` — Execute / eval / run
- **Runner:** from canonical op belt map
- **Verify:** `field-program-combinatronic.py boil qbasic "NEW"`

### `RUN`
- **Boils to:** `exec` — Execute / eval / run
- **Runner:** from canonical op belt map
- **Verify:** `field-program-combinatronic.py boil qbasic "RUN"`

### `SHELL`
- **Boils to:** `exec` — Execute / eval / run
- **Runner:** from canonical op belt map
- **Verify:** `field-program-combinatronic.py boil qbasic "SHELL"`

### `CLEAR`
- **Boils to:** `free` — Free / delete / drop
- **Runner:** from canonical op belt map
- **Verify:** `field-program-combinatronic.py boil qbasic "CLEAR"`

### `KILL`
- **Boils to:** `free` — Free / delete / drop
- **Runner:** from canonical op belt map
- **Verify:** `field-program-combinatronic.py boil qbasic "KILL"`

### `CHAIN`
- **Boils to:** `import` — Import / use / require
- **Runner:** from canonical op belt map
- **Verify:** `field-program-combinatronic.py boil qbasic "CHAIN"`

### `_SCREENSHOW`
- **Boils to:** `io` — I/O / print / read / write file
- **Runner:** from canonical op belt map
- **Verify:** `field-program-combinatronic.py boil qbasic "_SCREENSHOW"`

### `CIRCLE`
- **Boils to:** `io` — I/O / print / read / write file
- **Runner:** from canonical op belt map
- **Verify:** `field-program-combinatronic.py boil qbasic "CIRCLE"`

### `CLOSE`
- **Boils to:** `io` — I/O / print / read / write file
- **Runner:** from canonical op belt map
- **Verify:** `field-program-combinatronic.py boil qbasic "CLOSE"`

### `CLS`
- **Boils to:** `io` — I/O / print / read / write file
- **Runner:** from canonical op belt map
- **Verify:** `field-program-combinatronic.py boil qbasic "CLS"`

### `COLOR`
- **Boils to:** `io` — I/O / print / read / write file
- **Runner:** from canonical op belt map
- **Verify:** `field-program-combinatronic.py boil qbasic "COLOR"`

### `DRAW`
- **Boils to:** `io` — I/O / print / read / write file
- **Runner:** from canonical op belt map
- **Verify:** `field-program-combinatronic.py boil qbasic "DRAW"`

### `INPUT`
- **Boils to:** `io` — I/O / print / read / write file
- **Runner:** from canonical op belt map
- **Verify:** `field-program-combinatronic.py boil qbasic "INPUT"`
...
- **Boils to:** `io` — I/O / print / read / write file
- **Runner:** from canonical op belt map
- **Verify:** `field-program-combinatronic.py boil qbasic "LINE"`

### `LOCATE`
- **Boils to:** `io` — I/O / print / read / write file
- **Runner:** from canonical op belt map
- **Verify:** `field-program-combinatronic.py boil qbasic "LOCATE"`

### `MKDIR`
- **Boils to:** `io` — I/O / print / read / write file
- **Runner:** from canonical op belt map
- **Verify:** `field-program-combinatronic.py boil qbasic "MKDIR"`

### `OPEN`
- **Boils to:** `io` — I/O / print / read / write file
- **Runner:** from canonical op belt map
- **Verify:** `field-program-combinatronic.py boil qbasic "OPEN"`

### `PAINT`
- **Boils to:** `io` — I/O / print / read / write file
- **Runner:** from canonical op belt map
- **Verify:** `field-program-combinatronic.py boil qbasic "PAINT"`

### `PRINT`
- **Boils to:** `io` — I/O / print / read / write file
- **Runner:** from canonical op belt map
- **Verify:** `field-program-combinatronic.py boil qbasic "PRINT"`
...
- **Boils to:** `io` — I/O / print / read / write file
- **Runner:** from canonical op belt map
- **Verify:** `field-program-combinatronic.py boil qbasic "READ"`

### `RESTORE`
- **Boils to:** `io` — I/O / print / read / write file
- **Runner:** from canonical op belt map
- **Verify:** `field-program-combinatronic.py boil qbasic "RESTORE"`

### `SCREEN`
- **Boils to:** `io` — I/O / print / read / write file
- **Runner:** from canonical op belt map
- **Verify:** `field-program-combinatronic.py boil qbasic "SCREEN"`

### `ASC`
- **Boils to:** `load` — Load / read memory
- **Runner:** from canonical op belt map
- **Verify:** `field-program-combinatronic.py boil qbasic "ASC"`

### `PEEK`
- **Boils to:** `load` — Load / read memory
- **Runner:** from canonical op belt map
- **Verify:** `field-program-combinatronic.py boil qbasic "PEEK"`

### `DO`
- **Boils to:** `loop` — Loop / iterate / repeat
- **Runner:** from canonical op belt map
- **Verify:** `field-program-combinatronic.py boil qbasic "DO"`

### `FOR`
- **Boils to:** `loop` — Loop / iterate / repeat
- **Runner:** from canonical op belt map
- **Verify:** `field-program-combinatronic.py boil qbasic "FOR"`

### `LOOP`
- **Boils to:** `loop` — Loop / iterate / repeat
- **Runner:** from canonical op belt map
- **Verify:** `field-program-combinatronic.py boil qbasic "LOOP"`

### `NEXT`
- **Boils to:** `loop` — Loop / iterate / repeat
- **Runner:** from canonical op belt map
- **Verify:** `field-program-combinatronic.py boil qbasic "NEXT"`

### `STEP`
- **Boils to:** `loop` — Loop / iterate / repeat
- **Runner:** from canonical op belt map
- **Verify:** `field-program-combinatronic.py boil qbasic "STEP"`

### `TO`
- **Boils to:** `loop` — Loop / iterate / repeat
- **Runner:** from canonical op belt map
- **Verify:** `field-program-combinatronic.py boil qbasic "TO"`

### `UNTIL`
- **Boils to:** `loop` — Loop / iterate / repeat
- **Runner:** from canonical op belt map
- **Verify:** `field-program-combinatronic.py boil qbasic "UNTIL"`

### `WEND`
- **Boils to:** `loop` — Loop / iterate / repeat
- **Runner:** from canonical op belt map
- **Verify:** `field-program-combinatronic.py boil qbasic "WEND"`

### `WHILE`
- **Boils to:** `loop` — Loop / iterate / repeat
- **Runner:** from canonical op belt map
- **Verify:** `field-program-combinatronic.py boil qbasic "WHILE"`

### `CASE`
- **Boils to:** `match` — Pattern match / case
- **Runner:** from canonical op belt map
- **Verify:** `field-program-combinatronic.py boil qbasic "CASE"`

### `SELECT CASE`
- **Boils to:** `match` — Pattern match / case
- **Runner:** from canonical op belt map
- **Verify:** `field-program-combinatronic.py boil qbasic "SELECT CASE"`

### `ABS`
- **Boils to:** `math` — Math / arithmetic
- **Runner:** from canonical op belt map
- **Verify:** `field-program-combinatronic.py boil qbasic "ABS"`

### `INT`
- **Boils to:** `math` — Math / arithmetic
- **Runner:** from canonical op belt map
- **Verify:** `field-program-combinatronic.py boil qbasic "INT"`

### `RND`
- **Boils to:** `math` — Math / arithmetic
- **Runner:** from canonical op belt map
- **Verify:** `field-program-combinatronic.py boil qbasic "RND"`

### `SGN`
- **Boils to:** `math` — Math / arithmetic
- **Runner:** from canonical op belt map
- **Verify:** `field-program-combinatronic.py boil qbasic "SGN"`

### `END`
- **Boils to:** `return` — Return / exit function
- **Runner:** from canonical op belt map
- **Verify:** `field-program-combinatronic.py boil qbasic "END"`

### `END FUNCTION`
- **Boils to:** `return` — Return / exit function
- **Runner:** from canonical op belt map
- **Verify:** `field-program-combinatronic.py boil qbasic "END FUNCTION"`

### `END SUB`
- **Boils to:** `return` — Return / exit function
- **Runner:** from canonical op belt map
- **Verify:** `field-program-combinatronic.py boil qbasic "END SUB"`

### `RETURN`
- **Boils to:** `return` — Return / exit function
- **Runner:** from canonical op belt map
- **Verify:** `field-program-combinatronic.py boil qbasic "RETURN"`

### `STOP`
- **Boils to:** `return` — Return / exit function
- **Runner:** from canonical op belt map
- **Verify:** `field-program-combinatronic.py boil qbasic "STOP"`

### `POKE`
- **Boils to:** `store` — Store / write memory
- **Runner:** from canonical op belt map
- **Verify:** `field-program-combinatronic.py boil qbasic "POKE"`

### `CHR$`
- **Boils to:** `string` — String / format / concat
- **Runner:** from canonical op belt map
- **Verify:** `field-program-combinatronic.py boil qbasic "CHR$"`

### `LEFT$`
- **Boils to:** `string` — String / format / concat
- **Runner:** from canonical op belt map
- **Verify:** `field-program-combinatronic.py boil qbasic "LEFT$"`

### `MID$`
- **Boils to:** `string` — String / format / concat
- **Runner:** from canonical op belt map
- **Verify:** `field-program-combinatronic.py boil qbasic "MID$"`

### `RIGHT$`
- **Boils to:** `string` — String / format / concat
- **Runner:** from canonical op belt map
- **Verify:** `field-program-combinatronic.py boil qbasic "RIGHT$"`

### `STR$`
- **Boils to:** `string` — String / format / concat
- **Runner:** from canonical op belt map
- **Verify:** `field-program-combinatronic.py boil qbasic "STR$"`

## Execution model

QBasic programs execute through the Field program combinatronic facet. Surface syntax
...
per QBasic reference rules. Hostess7 boil heuristics treat unknown tokens as exec
...
The QBasic value space follows the language reference: primitives, aggregates,
...
In QBasic, control constructs in the seed pack boil as follows:

- **branch:** `IF`, `THEN`, `ELSE`, `ELSEIF`, `ENDIF`, `GOTO`, `ON`, `CASE ELSE`
...
Verify any keyword with `field-program-combinatronic.py boil qbasic "<cmd>"`.
...
QBasic may embed in Queen Code, Grok16 belt builds, or NEXUS panel scripts.
...
Every QBasic compile and run path is sealed — **no bare host exec**. User code passes
...
- **Run:** `g16-secure-chamber.py run <path> --lang qbasic`
- **Posture:** `/api/g16/secure-chamber` · `nexus-g16-bridge.py json` → `secure_chamber`
- **Queen launch:** `runner_policy.qbasic` = `chamber` in `.launch` manifests
...
See `training_qbasic` on the Dewey shelf when published.
Field Research book and g16-power-sort plates inform algorithm choices in tooling.

## G16 compile path

- **Boil:** `field-program-combinatronic.py boil qbasic`
...
Representative QBasic patterns map to canonical ops as follows:
...
- Case sensitivity varies — QBasic keywords may not match heuristic boil.
...
- **Never run QBasic on the bare host** — shell escapes, `eval`, `system`, and JVM/Node
...
- Manual: `library/dewey/000-computer-science/explaining_qbasic/`
- Reader API: `/api/lang-manuals` · `/api/lang-manuals/qbasic`
